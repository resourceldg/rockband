...
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(header0, "class", "svelte-1gn6u0b");
      add_location(header0, file$4, 69, 6, 1156);
      add_location(div0, file$4, 71, 8, 1232);
      add_location(div1, file$4, 74, 8, 1281);
      attr_dev(section0, "class", "svelte-1gn6u0b");
      add_location(section0, file$4, 70, 6, 1214);
      attr_dev(div2, "class", "slide-content svelte-1gn6u0b");
      add_location(div2, file$4, 68, 4, 1122);
      set_style(header1, "background-image", "url(fdm_2.png)");
      attr_dev(header1, "class", "svelte-1gn6u0b");
      add_location(header1, file$4, 78, 6, 1360);
      add_location(div3, file$4, 80, 8, 1436);
      add_location(div4, file$4, 83, 8, 1485);
      attr_dev(section1, "class", "svelte-1gn6u0b");
      add_location(section1, file$4, 79, 6, 1418);
      attr_dev(div5, "class", "slide-content svelte-1gn6u0b");
      add_location(div5, file$4, 77, 4, 1326);
      set_style(header2, "background-image", "url(//placekitten.com/320)");
      attr_dev(header2, "class", "svelte-1gn6u0b");
      add_location(header2, file$4, 87, 6, 1564);
      add_location(div6, file$4, 89, 8, 1652);
      add_location(div7, file$4, 92, 8, 1701);
      attr_dev(section2, "class", "svelte-1gn6u0b");
      add_location(section2, file$4, 88, 6, 1634);
      attr_dev(div8, "class", "slide-content svelte-1gn6u0b");
      add_location(div8, file$4, 86, 4, 1530);
    },
    m: function mount(target, anchor) {
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div0, "class", "demo svelte-1gn6u0b");
      add_location(div0, file$4, 65, 0, 1060);
      attr_dev(a, "class", "a");
      attr_dev(a, "href", "https://github.com/resourceldg/waladocs/issue");
      add_location(a, file$4, 102, 4, 1941);
      attr_dev(p, "class", "pb-4");
      add_location(p, file$4, 99, 2, 1772);
      add_location(h3, file$4, 105, 2, 2088);
      add_location(h4, file$4, 106, 2, 2108);
      add_location(div1, file$4, 98, 0, 1764);
    },
    m: function mount(target, anchor) {
...
class Routes extends SvelteComponentDev {
  constructor(options) {
    super(options);
    if (!document.getElementById("svelte-1gn6u0b-style")) add_css$2();
