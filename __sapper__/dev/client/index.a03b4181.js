...
function add_css$2() {
  var style = element("style");
  style.id = "svelte-1rpl52d-style";
  style.textContent = ".demo.svelte-1rpl52d.svelte-1rpl52d{margin:0;padding-bottom:30px;height:230px;width:auto}@media screen and (min-width: 900px){.slide-content.svelte-1rpl52d.svelte-1rpl52d{display:flex;flex-direction:column;height:500px;width:auto;background-color:#0000;margin:0;padding-bottom:30px}.slide-content.svelte-1rpl52d header.svelte-1rpl52d{height:400px;width:auto;background-size:cover;margin:0;padding:0}.slide-content.svelte-1rpl52d section.svelte-1rpl52d{height:100px;margin:0;padding-bottom:30px;padding-top:30px;color:aqua}}@media screen and (max-width: 600px){.slide-content.svelte-1rpl52d.svelte-1rpl52d{height:350px;width:auto}.slide-content.svelte-1rpl52d header.svelte-1rpl52d{height:200px;width:auto}.slide-content.svelte-1rpl52d section.svelte-1rpl52d{height:100px}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
  append_dev(document.head, style);
} // (95:2) <Carousel perPage="1" dots="false">
...
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(header0, "class", "svelte-1rpl52d");
      add_location(header0, file$4, 96, 6, 1475);
      add_location(div0, file$4, 98, 8, 1551);
      add_location(div1, file$4, 101, 8, 1600);
      attr_dev(section0, "class", "svelte-1rpl52d");
      add_location(section0, file$4, 97, 6, 1533);
      attr_dev(div2, "class", "slide-content svelte-1rpl52d");
      add_location(div2, file$4, 95, 4, 1441);
      set_style(header1, "background-image", "url(fdm_2.png)");
      attr_dev(header1, "class", "svelte-1rpl52d");
      add_location(header1, file$4, 105, 6, 1679);
      add_location(div3, file$4, 107, 8, 1755);
      add_location(div4, file$4, 110, 8, 1804);
      attr_dev(section1, "class", "svelte-1rpl52d");
      add_location(section1, file$4, 106, 6, 1737);
      attr_dev(div5, "class", "slide-content svelte-1rpl52d");
      add_location(div5, file$4, 104, 4, 1645);
      set_style(header2, "background-image", "url(//placekitten.com/320)");
      attr_dev(header2, "class", "svelte-1rpl52d");
      add_location(header2, file$4, 114, 6, 1883);
      add_location(div6, file$4, 116, 8, 1971);
      add_location(div7, file$4, 119, 8, 2020);
      attr_dev(section2, "class", "svelte-1rpl52d");
      add_location(section2, file$4, 115, 6, 1953);
      attr_dev(div8, "class", "slide-content svelte-1rpl52d");
      add_location(div8, file$4, 113, 4, 1849);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(95:2) <Carousel perPage=\\\"1\\\" dots=\\\"false\\\">",
    ctx
  });
  return block;
}
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div0, "class", "demo svelte-1rpl52d");
      add_location(div0, file$4, 92, 0, 1379);
      attr_dev(a, "class", "a");
      attr_dev(a, "href", "https://github.com/resourceldg/waladocs/issue");
      add_location(a, file$4, 129, 4, 2260);
      attr_dev(p, "class", "pb-4");
      add_location(p, file$4, 126, 2, 2091);
      add_location(h3, file$4, 132, 2, 2407);
      add_location(h4, file$4, 133, 2, 2427);
      add_location(div1, file$4, 125, 0, 2083);
    },
    m: function mount(target, anchor) {
...
class Routes extends SvelteComponentDev {
  constructor(options) {
    super(options);
    if (!document.getElementById("svelte-1rpl52d-style")) add_css$2();
