import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, e as element, a as append_dev, v as validate_slots, H as text, g as claim_element, h as children, J as claim_text, j as detach_dev, l as attr_dev, m as add_location, n as insert_dev, N as set_data_dev, D as noop, f as space, k as claim_space, M as set_style, b as createEventDispatcher, p as listen_dev, r as run_all, O as set_input_value, P as bubble, Q as to_number, w as validate_each_argument, R as toggle_class, x as destroy_each, B as binding_callbacks, T as bind, F as globals, G as create_component, I as claim_component, K as mount_component, U as add_flush_callback, t as transition_in, q as transition_out, L as destroy_component } from './client.ba5cec92.js';
...
function create_fragment$6(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(p, file$6, 13, 6, 387);
      attr_dev(div1, "class", "grid col-span-2 justify-self-center");
      add_location(div1, file$6, 12, 4, 331);
      if (img.src !== (img_src_value = "desc.svg ")) attr_dev(img, "src", img_src_value);
      attr_dev(img, "alt", "disc");
      add_location(img, file$6, 21, 10, 666);
      attr_dev(a, "href", "PASO A PASO.mp3");
      attr_dev(a, "download", "PASO A PASO.mp3");
      add_location(a, file$6, 20, 10, 601);
      attr_dev(button, "class", "bg-blue-gray-700 hover:bg-gray-900  text-gray-500  font-bold py-2 px-4\n          rounded-full");
      add_location(button, file$6, 17, 8, 470);
      add_location(div2, file$6, 15, 4, 450);
      attr_dev(div3, "class", "grid md:grid-cols-3 gap-4 rounded-bl place-items-center shadow-lg p-4  mt-30 mb-10");
