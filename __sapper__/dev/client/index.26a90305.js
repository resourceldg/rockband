...
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(header0, "class", "svelte-zi4wow");
      add_location(header0, file$4, 69, 6, 1142);
      add_location(div0, file$4, 71, 8, 1218);
      add_location(div1, file$4, 74, 8, 1267);
      attr_dev(section0, "class", "svelte-zi4wow");
      add_location(section0, file$4, 70, 6, 1200);
      attr_dev(div2, "class", "slide-content svelte-zi4wow");
      add_location(div2, file$4, 68, 4, 1108);
      set_style(header1, "background-image", "url(fdm_2.png)");
      attr_dev(header1, "class", "svelte-zi4wow");
      add_location(header1, file$4, 78, 6, 1346);
      add_location(div3, file$4, 80, 8, 1422);
      add_location(div4, file$4, 83, 8, 1471);
      attr_dev(section1, "class", "svelte-zi4wow");
      add_location(section1, file$4, 79, 6, 1404);
      attr_dev(div5, "class", "slide-content svelte-zi4wow");
      add_location(div5, file$4, 77, 4, 1312);
      set_style(header2, "background-image", "url(//placekitten.com/320)");
      attr_dev(header2, "class", "svelte-zi4wow");
      add_location(header2, file$4, 87, 6, 1550);
      add_location(div6, file$4, 89, 8, 1638);
      add_location(div7, file$4, 92, 8, 1687);
      attr_dev(section2, "class", "svelte-zi4wow");
      add_location(section2, file$4, 88, 6, 1620);
      attr_dev(div8, "class", "slide-content svelte-zi4wow");
      add_location(div8, file$4, 86, 4, 1516);
    },
    m: function mount(target, anchor) {
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div0, "class", "demo svelte-zi4wow");
      add_location(div0, file$4, 65, 0, 1046);
      attr_dev(a, "class", "a");
      attr_dev(a, "href", "https://github.com/resourceldg/waladocs/issue");
      add_location(a, file$4, 102, 4, 1927);
      attr_dev(p, "class", "pb-4");
      add_location(p, file$4, 99, 2, 1758);
      add_location(h3, file$4, 105, 2, 2074);
      add_location(h4, file$4, 106, 2, 2094);
      add_location(div1, file$4, 98, 0, 1750);
    },
    m: function mount(target, anchor) {
...
class Routes extends SvelteComponentDev {
  constructor(options) {
    super(options);
    if (!document.getElementById("svelte-zi4wow-style")) add_css$2();
