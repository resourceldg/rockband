import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, e as element, a as append_dev, v as validate_slots, H as text, g as claim_element, h as children, J as claim_text, j as detach_dev, l as attr_dev, m as add_location, n as insert_dev, N as set_data_dev, D as noop, f as space, k as claim_space, M as set_style, b as createEventDispatcher, p as listen_dev, r as run_all, O as set_input_value, P as bubble, Q as to_number, w as validate_each_argument, R as toggle_class, x as destroy_each, B as binding_callbacks, T as bind, F as globals, G as create_component, I as claim_component, K as mount_component, U as add_flush_callback, t as transition_in, q as transition_out, L as destroy_component } from './client.42efe6e2.js';
...
function create_fragment$6(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$6, 6, 4, 180);
      ...
      add_location(img0, file$6, 11, 12, 391);
      attr_dev(div1, "class", "grid justify-self-start");
      add_location(div1, file$6, 10, 8, 340);
      attr_dev(div2, "class", "grid col-span-2 justify-self-center");
      add_location(div2, file$6, 12, 8, 461);
      if (img1.src !== (img1_src_value = "desc.jpg")) attr_dev(img1, "src", img1_src_value);
      attr_dev(img1, "alt", "paso a paso tema 1");
      add_location(img1, file$6, 14, 12, 722);
      attr_dev(a, "href", "PASO A PASO.mp3");
      attr_dev(a, "download", "");
      add_location(a, file$6, 13, 90, 674);
      attr_dev(button, "class", "border-yellow-500 border-2");
      add_location(button, file$6, 13, 46, 630);
      attr_dev(div3, "class", "grid sm:justify-self-end");
      add_location(div3, file$6, 13, 8, 592);
      attr_dev(div4, "class", "grid md:grid-cols-4 gap-4 rounded-bl place-items-center  shadow-lg p-4 mt-30 mb-10");
      add_location(div4, file$6, 9, 8, 235);
