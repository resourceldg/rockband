...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(p1, file$4, 167, 9, 4082);
      add_location(br0, file$4, 167, 45, 4118);
      add_location(p2, file$4, 168, 6, 4129);
      add_location(br1, file$4, 168, 38, 4161);
      add_location(p3, file$4, 169, 6, 4172);
      add_location(br2, file$4, 169, 38, 4204);
      add_location(p4, file$4, 170, 6, 4215);
      add_location(br3, file$4, 170, 34, 4243);
      add_location(p5, file$4, 171, 6, 4254);
      add_location(br4, file$4, 171, 39, 4287);
      add_location(div0, file$4, 167, 4, 4077);
      add_location(p6, file$4, 174, 6, 4319);
      add_location(br5, file$4, 174, 39, 4352);
      add_location(p7, file$4, 175, 6, 4363);
      add_location(br6, file$4, 175, 44, 4401);
      add_location(p8, file$4, 176, 6, 4412);
      add_location(br7, file$4, 176, 50, 4456);
      add_location(p9, file$4, 177, 6, 4467);
      add_location(br8, file$4, 177, 39, 4500);
      add_location(p10, file$4, 178, 6, 4511);
      add_location(div1, file$4, 173, 4, 4307);
      attr_dev(div2, "class", "grid grid-cols-1 md:grid-cols-2 mt-4");
