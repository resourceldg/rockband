...
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(header0, "class", "svelte-7uc0bg");
      add_location(header0, file$4, 70, 6, 1179);
      add_location(div0, file$4, 72, 8, 1255);
      add_location(div1, file$4, 75, 8, 1304);
      attr_dev(section0, "class", "svelte-7uc0bg");
      add_location(section0, file$4, 71, 6, 1237);
      attr_dev(div2, "class", "slide-content svelte-7uc0bg");
      add_location(div2, file$4, 69, 4, 1145);
      set_style(header1, "background-image", "url(fdm_2.png)");
      attr_dev(header1, "class", "svelte-7uc0bg");
      add_location(header1, file$4, 79, 6, 1383);
      add_location(div3, file$4, 81, 8, 1459);
      add_location(div4, file$4, 84, 8, 1508);
      attr_dev(section1, "class", "svelte-7uc0bg");
      add_location(section1, file$4, 80, 6, 1441);
      attr_dev(div5, "class", "slide-content svelte-7uc0bg");
      add_location(div5, file$4, 78, 4, 1349);
      set_style(header2, "background-image", "url(//placekitten.com/320)");
      attr_dev(header2, "class", "svelte-7uc0bg");
      add_location(header2, file$4, 88, 6, 1587);
      add_location(div6, file$4, 90, 8, 1675);
      add_location(div7, file$4, 93, 8, 1724);
      attr_dev(section2, "class", "svelte-7uc0bg");
      add_location(section2, file$4, 89, 6, 1657);
      attr_dev(div8, "class", "slide-content svelte-7uc0bg");
      add_location(div8, file$4, 87, 4, 1553);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(69:2) <Carousel perPage=\\\"1\\\" dots=\\\"false\\\">",
    ctx
  });
  return block;
}
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div0, "class", "demo svelte-7uc0bg");
      add_location(div0, file$4, 66, 0, 1083);
      attr_dev(a, "class", "a");
      attr_dev(a, "href", "https://github.com/resourceldg/waladocs/issue");
      add_location(a, file$4, 103, 4, 1964);
      attr_dev(p, "class", "pb-4");
      add_location(p, file$4, 100, 2, 1795);
      add_location(h3, file$4, 106, 2, 2111);
      add_location(h4, file$4, 107, 2, 2131);
      add_location(div1, file$4, 99, 0, 1787);
    },
    m: function mount(target, anchor) {
...
class Routes extends SvelteComponentDev {
  constructor(options) {
    super(options);
    if (!document.getElementById("svelte-7uc0bg-style")) add_css$2();
